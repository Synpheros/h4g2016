...
public class School5 : MonoBehaviour
{
	...
	void Start()
    {
		...
		sequence.Add(new SequenceNode("Alicia: Eres un perdedor, no te molestes en hablarme más", new int[] { 0, -1, 22 }));
		sequence.Add(new SequenceNode("Inés: No sé para qué vienes a clase, no te va a servir de nada", new int[] { 0, 10, 22 }));
